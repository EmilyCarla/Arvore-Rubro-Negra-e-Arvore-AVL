...
public class ArvoreAVL {
    ...
    private int countOccurrences(long key) {
        return countOccurrences(root, key);
    }

    private int countOccurrences(Node node, long key) {
        if (node == null) {
            return 0;
        }

        int compareResult = Long.compare(key, node.data);
        if (compareResult < 0) {
    ...
    public void performRandomOperations() {
        ...
        for (int i = 0; i < 50000; i++) {
            long randomNumber = random.nextInt(19999) - 9999; // 
            ...
            if (randomNumber % 3 == 0) {
                ...
                int occurrences = countOccurrences(randomNumber);
                System.out.println("Número " + randomNumber + " aparece na árvore AVL " + occurrences + " vezes.");
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        avlTree.performRandomOperations();
    }
}
